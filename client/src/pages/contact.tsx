...
export default function ContactPage() {
  useSEO({
    path: '/contact',
    en: {
      title: 'Contact TechPartner | Get a Free Design & Development Consultation',
      description: 'Contact TechPartner in Riyadh, Saudi Arabia for logo design, web design, and custom development services. Get a free consultation. Email: info@techpartner.sa | Phone: +966 50 123 4567.',
      keywords: 'contact TechPartner, design agency contact Riyadh, web development consultation Saudi Arabia, free design consultation KSA, hire designer Saudi Arabia',
    },
    ar: {
      title: 'تواصل مع تك بارتنر | احصل على استشارة تصميم وتطوير مجانية',
      description: 'تواصل مع تك بارتنر في الرياض، المملكة العربية السعودية لخدمات تصميم الشعارات وتصميم المواقع والتطوير المخصص. احصل على استشارة مجانية. البريد: info@techpartner.sa | الهاتف: +966 50 123 4567.',
      keywords: 'تواصل تك بارتنر, وكالة تصميم الرياض, استشارة تطوير مواقع السعودية, استشارة تصميم مجانية, توظيف مصمم السعودية',
    },
  });
