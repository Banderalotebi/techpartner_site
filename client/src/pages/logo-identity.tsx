...
export default function LogoIdentityPage() {
  useSEO({
    ...
    en: {
      title: 'Logo & Brand Identity Design Packages | TechPartner Saudi Arabia',
      description: 'Professional logo and brand identity design packages in Saudi Arabia. Starter from 2,135 SAR to Elite at 8,996 SAR. 30–50 design concepts, money-back guarantee, junior to expert designers.',
      keywords: 'logo design packages Saudi Arabia, brand identity design Riyadh, custom logo KSA, business card design, brand guidelines, logo contest Saudi Arabia, professional logo designer',
    },
    ar: {
      title: 'باقات تصميم الشعار والهوية التجارية | تك بارتنر السعودية',
      description: 'باقات تصميم شعار وهوية تجارية احترافية في المملكة العربية السعودية. من 2,135 ريال للباقة الأساسية إلى 8,996 ريال للباقة المتميزة. 30-50 مفهوم تصميم مع ضمان استرداد الأموال.',
      keywords: 'باقات تصميم شعار السعودية, تصميم هوية تجارية الرياض, شعار مخصص, تصميم بطاقة أعمال, إرشادات العلامة التجارية, مصمم شعار محترف',
    },
  });
