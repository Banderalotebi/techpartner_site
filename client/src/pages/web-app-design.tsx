...
export default function WebAppDesignPage() {
  ...
  // Determine if this is a web development page (declared early so useSEO can use it)
  const isWebDevelopment = location.includes('/web-development');

  useSEO({
    path: isWebDevelopment ? '/categories/web-development' : '/categories/web-and-app-design',
    en: isWebDevelopment ? {
      title: 'Custom Web Development Services | TechPartner Saudi Arabia',
      description: 'Full-stack custom web development in Saudi Arabia. Starter from 25,000 SAR, Business Pro 35,000 SAR, Enterprise 45,000 SAR. React, Node.js, CMS, authentication, API integration.',
      keywords: 'custom web development Saudi Arabia, full stack developer KSA, React developer Riyadh, Node.js development, web application development Saudi Arabia, enterprise web development',
    } : {
      title: 'Web & App Design Services | TechPartner Saudi Arabia',
      description: 'Professional web and app design services in Saudi Arabia. Website builders, landing pages, WordPress themes, app design, iOS & Android apps. Starting from 400 SAR.',
      keywords: 'web design Saudi Arabia, app design KSA, landing page design Riyadh, WordPress theme design, iOS app design Saudi Arabia, Android app design, website redesign KSA',
    },
    ar: isWebDevelopment ? {
      title: 'خدمات تطوير الويب المخصص | تك بارتنر السعودية',
      description: 'تطوير ويب مخصص متكامل في المملكة العربية السعودية. الباقة الأساسية من 25,000 ريال، الأعمال الاحترافية 35,000 ريال، المؤسسات 45,000 ريال. React وNode.js وأنظمة إدارة المحتوى.',
      keywords: 'تطوير ويب مخصص السعودية, مطور متكامل, مطور React الرياض, تطوير Node.js, تطوير تطبيقات ويب السعودية',
    } : {
      title: 'خدمات تصميم المواقع والتطبيقات | تك بارتنر السعودية',
      description: 'خدمات تصميم مواقع وتطبيقات احترافية في المملكة العربية السعودية. منشئو مواقع وصفحات هبوط وقوالب ووردبريس وتصميم تطبيقات iOS وAndroid. ابتداءً من 400 ريال.',
      keywords: 'تصميم مواقع السعودية, تصميم تطبيقات, تصميم صفحة هبوط الرياض, تصميم قالب ووردبريس, تصميم تطبيق iOS, تصميم تطبيق Android',
    },
  });
