...
export default function AboutPage() {
  useSEO({
    path: '/about',
    en: {
      title: 'About TechPartner | Design & Development Agency in Saudi Arabia',
      description: 'Learn about TechPartner — a leading design and development agency in Riyadh, Saudi Arabia. 500+ projects, 150+ happy clients, expert designers and developers. Trusted by businesses across KSA.',
      keywords: 'about TechPartner, design agency Saudi Arabia, web development company Riyadh, brand identity agency KSA, professional designers Saudi Arabia',
    },
    ar: {
      title: 'من نحن | تك بارتنر - وكالة تصميم وتطوير في السعودية',
      description: 'تعرف على تك بارتنر — وكالة تصميم وتطوير رائدة في الرياض، المملكة العربية السعودية. أكثر من 500 مشروع و150 عميل راضٍ. مصممون ومطورون خبراء موثوق بهم من قِبل الشركات في جميع أنحاء المملكة.',
      keywords: 'من نحن تك بارتنر, وكالة تصميم السعودية, شركة تطوير مواقع الرياض, وكالة هوية تجارية, مصممون محترفون السعودية',
    },
  });
