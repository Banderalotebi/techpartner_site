...
export default function BlogPage() {
  useSEO({
    ...
    ogType: 'article',
    en: {
      title: 'TechPartner Blog | Design, Web Development & Digital Transformation Insights',
      description: 'Read expert articles on logo design, brand identity, web development, Arabic typography, and digital transformation in Saudi Arabia and the MENA region. Updated regularly.',
      keywords: 'design blog Saudi Arabia, web development articles, brand identity tips, Arabic web design, digital transformation MENA, logo design guide, TechPartner blog',
    },
    ar: {
      title: 'مدونة تك بارتنر | رؤى التصميم وتطوير الويب والتحول الرقمي',
      description: 'اقرأ مقالات خبراء حول تصميم الشعارات والهوية التجارية وتطوير الويب والطباعة العربية والتحول الرقمي في المملكة العربية السعودية ومنطقة الشرق الأوسط وشمال أفريقيا.',
      keywords: 'مدونة تصميم السعودية, مقالات تطوير الويب, نصائح الهوية التجارية, تصميم ويب عربي, التحول الرقمي, دليل تصميم الشعارات, مدونة تك بارتنر',
    },
  });
