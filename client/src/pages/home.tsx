...
import businessAdvertisingImage from "@assets/business and advertimeg.png";
...
export default function Home() {
  useSEO({
    path: '/',
    en: {
      title: 'TechPartner | Logo Design, Branding & Web Development in Saudi Arabia',
      description: 'TechPartner delivers professional logo design, brand identity, web design, and custom web development in Saudi Arabia. 500+ projects delivered. Starting from 1,500 SAR. Get a free consultation.',
      keywords: 'logo design Saudi Arabia, brand identity Riyadh, web development KSA, custom website design, graphic design Saudi Arabia, e-commerce development, TechPartner',
    },
    ar: {
      title: 'تك بارتنر | تصميم شعار، هوية تجارية وتطوير مواقع في السعودية',
      description: 'تك بارتنر تقدم خدمات تصميم الشعارات والهوية التجارية وتصميم المواقع وتطوير الويب المخصص في المملكة العربية السعودية. أكثر من 500 مشروع منجز. ابتداءً من 1,500 ريال. احصل على استشارة مجانية.',
      keywords: 'تصميم شعار السعودية, هوية تجارية الرياض, تطوير مواقع السعودية, تصميم موقع مخصص, تصميم جرافيك, تجارة إلكترونية, تك بارتنر',
    },
  });
