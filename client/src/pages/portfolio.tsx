...
export default function PortfolioPage() {
  useSEO({
    path: '/portfolio',
    en: {
      title: 'Portfolio | TechPartner Design & Development Projects in Saudi Arabia',
      description: 'Browse TechPartner\'s portfolio of 500+ completed projects — logo design, brand identity, e-commerce websites, web applications, and print design for businesses across Saudi Arabia and the MENA region.',
      keywords: 'design portfolio Saudi Arabia, web development projects KSA, logo design examples, brand identity portfolio, e-commerce website examples, TechPartner portfolio',
    },
    ar: {
      title: 'معرض الأعمال | مشاريع تصميم وتطوير تك بارتنر في السعودية',
      description: 'تصفح معرض أعمال تك بارتنر الذي يضم أكثر من 500 مشروع منجز — تصميم شعارات، هوية تجارية، مواقع تجارة إلكترونية، تطبيقات ويب، وتصميم طباعة للشركات في المملكة العربية السعودية ومنطقة الشرق الأوسط.',
      keywords: 'معرض أعمال تصميم السعودية, مشاريع تطوير ويب, أمثلة تصميم شعارات, معرض هوية تجارية, أمثلة مواقع تجارة إلكترونية, معرض تك بارتنر',
    },
  });
