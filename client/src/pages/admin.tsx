          ...
          <TabsContent value="inquiries" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View and manage customer inquiries from the campaign landing page</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="border rounded-lg">
                  <Table>
                      ...
                      {inquiriesLoading ? (
                        ...
                        inquiries.map((inquiry) => (
                          <TableRow key={inquiry.id}>
                            ...
                            <TableCell>{inquiry.companyRole || '-'}</TableCell>
                            <TableCell>
                              <a 
                                href={`https://wa.me/${inquiry.mobile.replace(/\D/g, '')}`}
                                target="_blank"
                            ...
                            <TableCell>
                              <Badge variant="outline" className="text-xs">
                                {inquiry.projectType.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}
                              </Badge>
                            </TableCell>
                            <TableCell>
                              <Badge variant={inquiry.language === 'ar' ? 'default' : 'secondary'}>
                                {inquiry.language === 'ar' ? 'العربية' : 'English'}
                              </Badge>
                            </TableCell>
                            <TableCell>
                              <Badge variant="outline" className="text-xs">
                ...
                {inquiries.length > 0 && (
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <Card>
                      <CardHeader className="pb-2">
                        <CardDescription>Arabic Users</CardDescription>
                        <CardTitle className="text-2xl">
                          {inquiries.filter(i => i.language === 'ar').length}
                        </CardTitle>
                      </CardHeader>
                    </Card>
                    <Card>
                      <CardHeader className="pb-2">
                        <CardDescription>English Users</CardDescription>
                        <CardTitle className="text-2xl">
                          {inquiries.filter(i => i.language === 'en').length}
                        </CardTitle>
                      </CardHeader>
                    </Card>
                    <Card>
                      <CardHeader className="pb-2">
                        ...
                        <CardTitle className="text-2xl">
                          {inquiries.filter(i => i.email).length}
                        </CardTitle>
                      </CardHeader>
                    </Card>
                  </div>
