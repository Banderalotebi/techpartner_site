  ...
  "logo-identity": [
    {
      ...
      price: "2135",
      features: ["Logo & business card design", "Letterhead & envelope", "Facebook cover", "30 Design concepts", "Money back guarantee", "Junior designer"],
      icon: "�"
    },
    {
      id: 2,
      ...
      price: "3222",
      features: ["Logo & business card design", "Letterhead & envelope", "Facebook cover", "35 Design concepts", "Money back guarantee", "Professional designer"],
      icon: "💼"
    },
    {
      id: 3,
      ...
      price: "5997",
      features: ["Logo & business card design", "Letterhead & envelope", "Facebook cover", "45 Design concepts", "Money back guarantee", "Senior designer"],
      icon: "⭐"
    },
    {
      id: 4,
      ...
      price: "8996",
      features: ["Logo & business card design", "Letterhead & envelope", "Facebook cover", "50 Design concepts", "Money back guarantee", "Expert designer"],
      icon: "�"
    },
    {
      id: 5,
...
const categorySEO: Record<string, { en: { title: string; description: string; keywords: string }; ar: { title: string; description: string; keywords: string }; path: string }> = {
  'logo-identity': {
    path: '/categories/logo-and-identity',
    en: {
      title: 'Logo & Brand Identity Design Services | TechPartner Saudi Arabia',
      description: 'Professional logo and brand identity design in Saudi Arabia. Packages from 2,135 SAR. Custom logos, business cards, letterheads, and complete brand guidelines. 30–50 design concepts.',
      keywords: 'logo design Saudi Arabia, brand identity Riyadh, custom logo KSA, business card design, brand guidelines, logo packages Saudi Arabia',
    },
    ar: {
      title: 'خدمات تصميم الشعار والهوية التجارية | تك بارتنر السعودية',
      description: 'تصميم شعار وهوية تجارية احترافية في المملكة العربية السعودية. باقات تبدأ من 2,135 ريال. شعارات مخصصة وبطاقات أعمال وأوراق رسمية وإرشادات علامة تجارية كاملة.',
      keywords: 'تصميم شعار السعودية, هوية تجارية الرياض, شعار مخصص, تصميم بطاقة أعمال, إرشادات العلامة التجارية',
    },
  },
  'web-app': {
    path: '/categories/web-and-app-design',
    en: {
      title: 'Web & App Design Services | TechPartner Saudi Arabia',
      description: 'Professional web and app design services in Saudi Arabia. Websites, e-commerce stores, Shopify, WordPress, Webflow, and custom platform development. Starting from 2,400 SAR.',
      keywords: 'web design Saudi Arabia, app design KSA, Shopify store setup, WordPress design, website redesign Riyadh, e-commerce design Saudi Arabia',
    },
    ar: {
      title: 'خدمات تصميم المواقع والتطبيقات | تك بارتنر السعودية',
      description: 'خدمات تصميم مواقع وتطبيقات احترافية في المملكة العربية السعودية. مواقع إلكترونية ومتاجر إلكترونية وشوبيفاي وووردبريس وتطوير منصات مخصصة. ابتداءً من 2,400 ريال.',
      keywords: 'تصميم مواقع السعودية, تصميم تطبيقات, إعداد متجر شوبيفاي, تصميم ووردبريس, إعادة تصميم موقع الرياض',
    },
  },
  'web-development': {
    path: '/categories/web-development',
    en: {
      title: 'Custom Web Development Services | TechPartner Saudi Arabia',
      description: 'Full-stack custom web application development in Saudi Arabia. 8-step technical assessment process. React, Node.js, databases, APIs, and cloud deployment. Starting from 25,000 SAR.',
      keywords: 'custom web development Saudi Arabia, full stack developer KSA, web application development Riyadh, React developer Saudi Arabia, Node.js development, API development KSA',
    },
    ar: {
      title: 'خدمات تطوير الويب المخصص | تك بارتنر السعودية',
      description: 'تطوير تطبيقات ويب مخصصة متكاملة في المملكة العربية السعودية. عملية تقييم تقني من 8 خطوات. React وNode.js وقواعد البيانات وواجهات برمجة التطبيقات والنشر السحابي. ابتداءً من 25,000 ريال.',
      keywords: 'تطوير ويب مخصص السعودية, مطور متكامل, تطوير تطبيقات ويب الرياض, مطور React السعودية, تطوير Node.js',
    },
  },
  'business-advertising': {
    path: '/categories/business-advertising',
    en: {
      title: 'Business & Advertising Design Services | TechPartner Saudi Arabia',
      description: 'Professional business and advertising design in Saudi Arabia. Posters, flyers, brochures, banners, menus, signage, and vehicle wraps. Starting from 400 SAR.',
      keywords: 'advertising design Saudi Arabia, flyer design KSA, brochure design Riyadh, poster design Saudi Arabia, business marketing materials, banner design KSA',
    },
    ar: {
      title: 'خدمات تصميم الأعمال والإعلان | تك بارتنر السعودية',
      description: 'تصميم أعمال وإعلانات احترافية في المملكة العربية السعودية. ملصقات ومنشورات وكتيبات ولافتات وقوائم طعام وإشارات وتغليف سيارات. ابتداءً من 400 ريال.',
      keywords: 'تصميم إعلانات السعودية, تصميم منشورات, تصميم كتيبات الرياض, تصميم ملصقات, مواد تسويقية',
    },
  },
  'art-illustration': {
    path: '/categories/art-illustration',
    en: {
      title: 'Art & Illustration Services | TechPartner Saudi Arabia',
      description: 'Custom art and illustration services in Saudi Arabia. Character design, mascots, concept art, portraits, cartoons, and book illustrations. Starting from 500 SAR.',
      keywords: 'illustration services Saudi Arabia, character design KSA, mascot design Riyadh, concept art Saudi Arabia, custom artwork, book illustration KSA',
    },
    ar: {
      title: 'خدمات الفن والرسوم التوضيحية | تك بارتنر السعودية',
      description: 'خدمات فن ورسوم توضيحية مخصصة في المملكة العربية السعودية. تصميم شخصيات وتمائم وفن مفاهيمي وصور شخصية ورسوم كرتونية ورسوم توضيحية للكتب. ابتداءً من 500 ريال.',
      keywords: 'خدمات رسوم توضيحية السعودية, تصميم شخصيات, تصميم تميمة الرياض, فن مفاهيمي, أعمال فنية مخصصة',
    },
  },
  'packaging-label': {
    path: '/categories/packaging-label',
    en: {
      title: 'Packaging & Label Design Services | TechPartner Saudi Arabia',
      description: 'Professional product packaging and label design in Saudi Arabia. Food packaging, cosmetic packaging, beverage labels, box design, and product labels. Starting from 400 SAR.',
      keywords: 'packaging design Saudi Arabia, label design KSA, food packaging Riyadh, cosmetic packaging Saudi Arabia, product label design, box design KSA',
    },
    ar: {
      title: 'خدمات تصميم التغليف والملصقات | تك بارتنر السعودية',
      description: 'تصميم تغليف منتجات وملصقات احترافية في المملكة العربية السعودية. تغليف الأغذية ومستحضرات التجميل وملصقات المشروبات وتصميم الصناديق وملصقات المنتجات. ابتداءً من 400 ريال.',
      keywords: 'تصميم تغليف السعودية, تصميم ملصقات, تغليف أغذية الرياض, تغليف مستحضرات تجميل, تصميم ملصق منتج',
    },
  },
  'social-media': {
    path: '/categories/social-media',
    en: {
      title: 'Social Media Design Services | TechPartner Saudi Arabia',
      description: 'Professional social media design in Saudi Arabia. Instagram posts, Facebook covers, LinkedIn banners, YouTube thumbnails, social media kits, and animated posts. Starting from 250 SAR.',
      keywords: 'social media design Saudi Arabia, Instagram design KSA, Facebook cover design, social media kit Riyadh, YouTube thumbnail design, LinkedIn banner Saudi Arabia',
    },
    ar: {
      title: 'خدمات تصميم وسائل التواصل الاجتماعي | تك بارتنر السعودية',
      description: 'تصميم وسائل تواصل اجتماعي احترافية في المملكة العربية السعودية. منشورات إنستغرام وأغلفة فيسبوك ولافتات لينكدإن ومصغرات يوتيوب وحزم وسائل التواصل الاجتماعي. ابتداءً من 250 ريال.',
      keywords: 'تصميم وسائل تواصل اجتماعي السعودية, تصميم إنستغرام, تصميم غلاف فيسبوك, حزمة وسائل التواصل الاجتماعي',
    },
  },
  'print-design': {
    path: '/categories/print-design',
    en: {
      title: 'Print Design Services | TechPartner Saudi Arabia',
      description: 'Professional print design services in Saudi Arabia. Business cards, letterheads, brochures, flyers, posters, banners, catalogs, and menus. Starting from 250 SAR.',
      keywords: 'print design Saudi Arabia, business card design KSA, brochure design Riyadh, flyer design Saudi Arabia, poster design, catalog design KSA',
    },
    ar: {
      title: 'خدمات تصميم الطباعة | تك بارتنر السعودية',
      description: 'خدمات تصميم طباعة احترافية في المملكة العربية السعودية. بطاقات أعمال وأوراق رسمية وكتيبات ومنشورات وملصقات ولافتات وكتالوجات وقوائم طعام. ابتداءً من 250 ريال.',
      keywords: 'تصميم طباعة السعودية, تصميم بطاقة أعمال, تصميم كتيبات الرياض, تصميم منشورات, تصميم ملصقات',
    },
  },
  'all-categories': {
    path: '/categories',
    en: {
      title: 'All Design & Development Services | TechPartner Saudi Arabia',
      description: 'Browse all professional design and development services by TechPartner in Saudi Arabia. Logo design, web development, social media, packaging, print design, and more. Starting from 250 SAR.',
      keywords: 'design services Saudi Arabia, web development KSA, logo design, brand identity, social media design, packaging design, print design Riyadh, TechPartner services',
    },
    ar: {
      title: 'جميع خدمات التصميم والتطوير | تك بارتنر السعودية',
      description: 'تصفح جميع خدمات التصميم والتطوير الاحترافية من تك بارتنر في المملكة العربية السعودية. تصميم شعارات وتطوير مواقع ووسائل تواصل اجتماعي وتغليف وتصميم طباعة والمزيد.',
      keywords: 'خدمات تصميم السعودية, تطوير مواقع, تصميم شعار, هوية تجارية, تصميم وسائل تواصل اجتماعي, تصميم تغليف, تصميم طباعة',
    },
  },
};
...
export default function CategoryPage() {
  ...
  const seoConfig = categorySEO[currentCategoryKey] || categorySEO['all-categories'];
  useSEO({ path: seoConfig.path, en: seoConfig.en, ar: seoConfig.ar });
  ...
  const handlePackageSelect = (service: any) => {
    // Allow users to proceed with order flow without authentication
    // Authentication will be handled within the order flow modals when needed
