...
export function WebDesignQuestionnaireModal({ 
  ...
  const handleNext = () => {
    if (currentStep === 5) {
      // After step 5 (Review), check authentication before going to payment
      if (!user && !loading) {
        setAuthModalOpen(true); // Show auth modal
      } else if (user) {
        setCurrentStep(6); // Go to payment if already authenticated
      }
  ...
  const handleAuthSuccess = () => {
    ...
    setCurrentStep(6); // Go to payment step after successful authentication
  };
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">Review and confirm your web design project</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <span>Business:</span>
                      <span>{questionnaireData.businessName || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Website Type:</span>
                      <span>
                        {websitePurposeOptions.find(opt => opt.id === questionnaireData.websitePurpose)?.title || 'Not specified'}
                      </span>
                    </div>
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <ul className="text-sm space-y-1">
                    ...
                    <li>• We'll start with wireframes and mockups</li>
                    <li>• Regular updates throughout the design process</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-green-700 font-semibold">Project details confirmed!</span>
                </div>
                <p className="text-green-600 text-sm mb-4">
                  Your design requirements have been captured. Our team will review and contact you with the next steps.
                </p>
                <Button 
                  onClick={onClose}
