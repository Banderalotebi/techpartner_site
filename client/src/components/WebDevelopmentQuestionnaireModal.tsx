...
export function WebDevelopmentQuestionnaireModal({ 
  ...
  const handleNext = () => {
    if (currentStep === 8) {
      // After step 8 (Review & Submit), check authentication before going to payment
      if (!user && !loading) {
        setAuthModalOpen(true); // Show auth modal
      } else if (user) {
        setCurrentStep(9); // Go to payment if already authenticated
      }
  ...
  const handleAuthSuccess = () => {
    ...
    setCurrentStep(9); // Go to payment step after successful authentication
  };
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 9:
        const finalPackage = getRecommendedPackage();
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <h3 className="text-xl font-semibold mb-2">Complete Your Order</h3>
              <p className="text-gray-600">Review and confirm your web development project</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between font-semibold text-lg pt-2 border-t">
                      <span>Total:</span>
                      <span className="text-[#01A1C1]">{finalPackage.price.toLocaleString()} SAR</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <ul className="text-sm space-y-1">
                    ...
                    <li>• We'll start with project planning and wireframes</li>
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <p className="text-green-600 text-sm mb-4">
                  Your questionnaire has been completed. Our team will review your requirements and contact you with the next steps.
                </p>
                <Button 
                  onClick={onClose}
